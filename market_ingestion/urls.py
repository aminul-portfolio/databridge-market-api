...
urlpatterns = [
    ...
    # Optional internal sample-write routes
    path("save-ohlcv-sample/", views.save_ohlcv_sample, name="save_ohlcv_sample"),
    path("save-trade/", views.save_trade, name="save_trade"),
]